  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          property="og:title"
          content="Criação de Sites e Landing Pages | Desenvolvedor Caike Marinho"
        />
           {" "}
        <meta
        ...
        <meta
          property="og:image"
          content="https://caikemarinho.com/redes.jpg"
        />{" "}
        {/* <--- SUA URL AQUI */}
        ...
        <title>
          Criação de Sites e Landing Pages | Desenvolvedor Caike Marinho
        </title>
            {/* --- CÓDIGO DA TAG DO GOOGLE ADS --- */}
        <script
          async
      ...
                  <SmoothScroll />
                  <GoogleAnalytics gaId="G-3H9BSCS7WX" />
                  <Component {...pageProps} />       {" "}
    </>
  );
}
